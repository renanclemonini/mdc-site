                ...
                ?>
                        <tr>
                            ...
                            <td>
                                ...
                                data-aniversario="<?php echo $objCliente['aniversario']; ?>"><img src="./imagens/database_edit.png" alt="editar"></button>
                            </td>
                            <td>
                                <button type="button" class="btn" 
                                data-toggle="modal" 
                                ...
                                data-id="<?php echo $objCliente['id']; ?>"
                                data-nome="<?php echo $objCliente['nome']; ?>"> <img src="./imagens/database_delete.png" alt="delete"> </button> 
                            </td>
                        </tr>
                <?php
                    }
